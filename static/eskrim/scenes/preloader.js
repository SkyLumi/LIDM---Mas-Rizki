export class Preloader extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('scorePanel', 'static/assets/eskrim_img/scorePanel.png')
        ...
        this.load.image('machinery', 'static/assets/eskrim_img/backgroundMesin.png')

        
        this.load.spritesheet('iceCreamFall', 'static/assets/eskrim_img/vanillaFall.png', {
            frameWidth: 150, frameHeight: 200
        })
        this.load.spritesheet('dispenser', 'static/assets/eskrim_img/dispenserArm.png', {
